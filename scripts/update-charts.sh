...
# the ./docs dir is published as https://udhos.github.io/redis-enforce-expire/

chart_dir=charts/redis-enforce-expire
chart_url=https://udhos.github.io/redis-enforce-expire/
